(() => {
    ...
    function initSliders() {
        if (document.querySelector(".section-hero__slider")) {
            const mainSlider = new swiper_core_Swiper(".swiper", {
...
***************************************************************************** */
    ...
    menuLinks.forEach((function(link) {
        if (link.href === currentPage) link.classList.add("activeCurrent");
    }));
    window["FLS"] = true;
    isWebp();
    addTouchClass();
